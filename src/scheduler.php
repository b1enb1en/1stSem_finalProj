...
<body>
    <nav class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="scheduler.php" class="active"><i class="bi bi-calendar-week"></i> Scheduler</a></li>
            <li><a href="manage_schedules.php"><i class="bi bi-pencil-square"></i> Edit Classes</a></li>
    ...
    <main class="main-content">
        ...
        <?php if (isset($_GET['msg'])): ?>
            <div id="success-alert" class="alert-box">Room booked successfully!</div>
        <?php endif; ?>
        ...
        <div class="box">
            ...
            <form method="get" style="display:flex; flex-wrap:wrap; gap:10px;">
                ...
                <div style="width:100%;"><button class="btn-primary">Search Availability</button></div>
            </form>
        </div>
